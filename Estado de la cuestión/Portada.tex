...
\usepackage[backend=biber, style=apa, language=spanish]{biblatex} %Config bibliography
...
\begin{center}
    ...
    \LARGE{\textbf{Estado de la cuestión}}
...
\Large Xalapa, Veracruz, México \hfill \Large agosto 2025
